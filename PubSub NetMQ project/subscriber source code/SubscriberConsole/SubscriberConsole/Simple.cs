    ...
    private void OnSubscriberMessage(object sender, NetMQSocketEventArgs e)
    {
      ...
      switch (topic)
      {
        ...
        case "HB":
          ...
          m_timeoutTimer.Enable = false;
          m_timeoutTimer.Enable = true;
          string message2 = e.Socket.ReceiveFrameString();
          Console.WriteLine("Message received. Topic: {0}, Message: {1}", topic, message2);
          break;
          ...
          m_timeoutTimer.Enable = false;
          m_timeoutTimer.Enable = true;
          string message3 = e.Socket.ReceiveFrameString();
          Console.WriteLine("Message received. Topic: {0}, Message: {1}", topic, message3);
          break;         
      }
    }
